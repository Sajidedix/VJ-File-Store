...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6170962395').split()]
...
CDB_NAME = environ.get("CDB_NAME", "helphm9")
...
DB_NAME = environ.get("DB_NAME", "sajideditz27")
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "1002367385611"))
...
WEBSITE_URL = environ.get("WEBSITE_URL", "https://sajidedix.onrender.com") # For More Information Check Video On Yt - @Tech_VJ
